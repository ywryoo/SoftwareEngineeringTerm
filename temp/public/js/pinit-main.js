! function(a, b, c, d) {
    var e = a[d.k] = {
        ...
        f: function() {
            return {
                ...
                call: function(a, b) {
                    var c, d, f, g, h = "?";
                    c = e.f.callback.length, d = e.a.k + ".f.callback[" + c + "]", e.f.callback[c] = function(a) {
                        a && (a.status && "failure" === a.status ? (g = a.message || a.status, "string" === typeof e.v.config.error && "function" === typeof e.w[e.v.config.error] && e.w[e.v.config.error](g), f = e.d.getElementById(e.a.k + ".f.callback[" + c + "]"), f && f.src && e.f.log("&type=api_error&code=" + a.code + "&msg=" + g + "&url=" + encodeURIComponent(f.src.split("?")[0]))) : "function" === typeof b && b(a, c)), e.f.kill(d)
                    ...
                    if (a && a.length)
                        ...
                        for (var f in a)
                            if ("string" === typeof a[f]) {
                                var g = a[f];
                                "text" === f && (b.innerHTML = b.innerHTML + g), "addClass" === f && (b.className = b.className + " " + e.a.k + "_" + g), e.a.build.setStyle[f] && ("backgroundImage" === f ? (b.style[f] = "url(" + g + ")", e.f.set(b, "data-pin-src", g)) : b.style[f] = g), e.a.build.setData[f] && e.f.set(b, "data-pin-" + f, g)
                            } else {
                                var h = e.f.make({
                                    SPAN: {
                                ...
                                if ("embed" === f || "video" === f)
                                    if ("embed" === f) {
                                        var i = a[f];
                                        i.type && "gif" === i.type ? b.appendChild(e.f.make({
                                            SPAN: {
                                                className: e.a.k + "_control " + e.a.k + "_paused",
                                                "data-pin-log": "embed_pin_play",
                                                "data-pin-src": i.src
                                            }
                                        })) : i.src && b.appendChild(e.f.make({
                                            IFRAME: {
                                        ...
                                        })), j.style.display = "none", b.appendChild(j), b.appendChild(e.f.make({
                                            SPAN: {
                ...
                over: function(a) {
                    var b, c, d;
                    b = a || e.w.event, c = e.f.getEl(b), c && (d = e.f.getData(c, "media") || c.src, "IMG" !== c.tagName || !d || d.match(/^data/) || e.f.getData(c, "no-hover") || e.f.get(c, "nopin") || e.f.getData(c, "nopin") ? e.v.hazHoverButton && c !== e.s.hoverButton && (e.v.hazHoverButton = !1, e.f.kill(e.s.hoverButton)) : (e.v.hazHoverButton || (e.v.hazHoverButton = !0), e.f.showHoverButton(c)))
                },
                structure: {
                    buttonPin: function(a, b) {
                        ...
                        return d = function(a) {
                            ...
                            text: f,
                            x: f
                        }), "true" === b.save ? (c.className = c.className + " save", c.text = e.a.strings[b.lang].save || e.a.strings[e.v.config.lang].save) : b.round ? c.className = c.className + " round" : ("ja" === b.lang && (c.className = c.className + " ja"), "red" === b.color && (c.className = c.className + " red"), "white" === b.color && (c.className = c.className + " white")), b.padded && (c.className = c.className + " padded"), b.tall && (c.className = c.className + " tall"), e.f.buildOne(c)
                    },
                        ...
                        if (a.data) {
                            for (c = a.data, (!b.columns || b.columns < 1 || b.columns > 10) && (b.columns = 5), b.height < 200 && (b.height = 340), s = e.v.config.pinterest + "/" + c.user.profile_url.split("pinterest.com/")[1], d = {
                                    ...
                                    hd: {
                                        href: s,
                                        img: {
                                            backgroundImage: c.user.image_small_url.replace(/_30.jpg/, "_60.jpg")
                                        },
                                        pinner: {
                    ...
                    embedPin: function(a, b) {
                        ...
                        return a.data && a.data[0] ? (c = a.data[0], c.error ? (e.f.log("&type=api_error&code=embed_pin_not_found&pin_id=" + c.id), !1) : (c.rich_metadata || (c.rich_metadata = {}), f = "", g = "", h = "", i = {
                            ...
                            ft: {
                                ...
                                img: {
                                    backgroundImage: c.pinner.image_small_url.replace(/30/, "60")
                                },
                                pinner: {
                        ...
                        }, d.bd.hd.repin.addClass = "save", d.bd.hd.repin.text = e.a.strings[b.lang].save, b.terse || (d.bd.description = {
                            text: c.description
                        }), c.rich_metadata.favicon_link || (d.bd.source.addClass = "nofav"), c.attribution && c.attribution.author_name && c.attribution.author_url && (d.bd.attribution = {
                        ...
                        }), (c.repin_count || c.like_count) && (d.bd.stats = {}, c.repin_count && (d.bd.stats.repins = {
                            text: "" + c.repin_count,
                            href: e.v.config.pinterest + "/pin/" + c.id + "/repins/"
                        }), c.like_count && (d.bd.stats.likes = {
                            text: "" + c.like_count,
                            href: e.v.config.pinterest + "/pin/" + c.id + "/likes/"
                ...
                seek: {
                    ...
                    buttonFollow: function(a) {
                        ...
                        if (f = {}, d = {
                                ...
                                lang: e.f.getData(a, "lang") || e.v.config.lang
                            }, e.f.checkLang(d), b = a.href.split("pinterest.com/"), b[1] && (c = b[1].split("/"), c[0])) {
                            if (f.name = a.innerHTML, f.id = c[0], c[0] && c[1] && (f.id = c[0] + "/" + c[1]), d.custom) return g = f.id.match(/\//) ? e.v.config.pinterest + "/" + f.id + "/follow/?guid=" + e.v.guid : e.v.config.pinterest + "/" + f.id + "/pins/follow/?guid=" + e.v.guid, e.f.set(a, "data-pin-href", g), e.f.set(a, "data-pin-log", "button_follow"), e.w.setTimeout(function() {
                    ...
                    embedBoard: function(a) {
                        var b, c, d, f, g;
                        b = a.href.split("#")[0].split("?")[0].split("pinterest.com/"), b[1] && (c = b[1].split("/"), c[0] && c[1] && (d = c[0] + "/" + c[1], f = {
                            ...
                            lang: e.f.getData(a, "lang") || e.v.config.lang
                        }, e.f.checkLang(f), e.f.getLegacy.grid(a, f), g = "", "https:" === e.w.location.protocol && (g = "&base_scheme=https"), e.f.call(e.a.endpoint.board.replace(/%s/, d) + "?sub=" + e.v.domain + g, function(b) {
                            e.f.replace(a, e.f.structure.embedGrid(b, f))
                        })))
                    },
                    embedUser: function(a) {
                        var b, c, d, f;
                        b = a.href.split("#")[0].split("?")[0].split("pinterest.com/"), b[1] && (c = b[1].split("/"), d = {
                            columns: e.f.getData(a, "columns") || e.v.config.grid.columns,
                            height: e.f.getData(a, "height") - 0 || e.v.config.grid.height,
                            width: e.f.getData(a, "width") || null,
                            noscroll: e.f.getData(a, "noscroll") || null,
                    ...
                    embedPin: function(a) {
                        var b, c, d, f;
                        b = a.href.split("#")[0].split("?")[0].split("pinterest.com/"), b[1] && (c = b[1].split("/"), c[1] && (d = {
                            width: e.f.getData(a, "width") || null,
                            terse: e.f.getData(a, "terse") || null,
                            lang: e.f.getData(a, "lang") || e.v.config.lang
                        }, e.f.checkLang(d), f = "", "https:" === e.w.location.protocol && (f = "&base_scheme=https"), e.f.call(e.a.endpoint.pin.replace(/%s/, c[1]) + "&sub=" + e.v.domain + f, function(b) {
                ...
                config: function() {
                    ...
                    e.v.config.lang ? e.a.strings[e.v.config.lang] || (e.f.debug(e.v.config.lang + " not found in valid languages, changing back to " + e.v.lang), e.v.config.lang = e.v.lang) : e.v.config.lang = e.v.lang, "string" === typeof e.v.config.build && (e.w[e.v.config.build] = function(a) {
                        ...
                        e.v.countPinMedium && (a = a + "&pin_count_medium=" + e.v.countPinMedium), e.v.countPinLarge && (a = a + "&pin_count_large=" + e.v.countPinLarge), a = a + "&profile_count=" + e.v.countProfile + "&board_count=" + e.v.countBoard, a = a + "&lang=" + e.v.config.lang, "number" !== typeof e.w["PIN_" + ~~((new Date).getTime() / 864e5)] && (a += "&xload=1"), e.f.log(a)
                    }, 1e3)
                },
                langLocLookup: function(a) {
                    var b, c, d, f, g, h;
                    if (a || (a = e.n.language), e.f.debug("Looking up language and domain for " + a), e.v.lang = "en", e.v.domain = "www", b = a.toLowerCase(), b = b.replace(/[^a-z0-9]/g, " "), b = b.replace(/^\s+|\s+$/g, ""), b = b.replace(/\s+/g, " "), b = b.split(" "), b.length > 2)
                        for (c = b.length - 1; c > -1; c -= 1) 2 !== b[c].length && b.splice(c, 1);
                    return b[0] && (d = b[0], e.a.strings[d] && (e.v.lang = d), e.a.save.domain[d] && (e.v.domain = d), b[1] && (f = b[1], f !== d && (g = !1, h = e.a.save.lookup[d], h && (h === !0 ? e.a.save.domain[f] || (e.v.domain = "www") : h.d === f ? e.v.domain = h.d : h.alt && h.alt[f] && ("string" === typeof h.alt[f] ? e.v.domain = h.alt[f] : (h.alt[f].d && (e.v.domain = h.alt[f].d, hazAltDom = !0), h.alt[f].s && (e.v.lang = h.alt[f].s)))), g || e.a.save.domain[f] && (e.v.domain = f)))), e.f.debug("Lang: " + e.v.lang), e.f.debug("Domain: " + e.v.domain), {
                        s: e.v.lang,
                        d: e.v.domain
                    }
                },
    ...
    configParam: ["save", "hover", "color", "lang", "custom", "tall", "round", "count", "zero", "terse", "debug", "tag", "build", "error", "util", "height", "shape", "save"],
